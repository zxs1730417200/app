          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                v-for="spuSale in item.spuSaleAttrValueList" 
                :key="spuSale.id"
                @click="changeActive(spuSale,item)">{{spuSale.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skunum" @change="inputquantity">
                <a href="javascript:" class="plus" @click.prevent="skunum++">+</a>
                <a href="javascript:" class="mins" @click.prevent="skunum>1?skunum--:skunum=1">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click.prevent="goshoppingtrolley">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      changeActive(spuSale,item){
        item.spuSaleAttrValueList.forEach(obj => {
          obj.isChecked=0
        });
        spuSale.isChecked=1
      },
